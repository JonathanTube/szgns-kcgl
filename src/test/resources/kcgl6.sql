...
CREATE TABLE IF NOT EXISTS `t_bill` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=34 DEFAULT CHARSET=utf8 COMMENT='出货单号';

-- 正在导出表  kcgl.t_bill 的数据：~2 rows (大约)
DELETE FROM `t_bill`;
/*!40000 ALTER TABLE `t_bill` DISABLE KEYS */;
INSERT INTO `t_bill` (`id`, `seq`, `cust_id`, `total_price`, `total_amount`, `total_money`, `create_user_id`, `create_time`) VALUES
	(32, '20150730131928295715', 3, 200, 1, 200, 1, '2015-07-30 13:19:28'),
	(33, '20150730132039783559', 4, 200, 1, 200, 1, '2015-07-30 13:20:39');
...
-- 正在导出表  kcgl.t_brand 的数据：~0 rows (大约)
DELETE FROM `t_brand`;
...
INSERT INTO `t_product` (`id`, `product_no`, `product_name`, `brand_id`, `tech_id`, `thickness_id`, `price`, `create_user_id`, `create_time`) VALUES
	(4, 'S1', 'XH1', 1, 1, 1, 101, 1, '2015-07-29 13:15:55'),
	(5, 'S2', 'XH2', 1, 1, 1, 200, 1, '2015-07-29 13:20:29'),
	(6, 'S3', 'XH3', 1, 1, 1, 300, 1, '2015-07-29 14:02:12'),
	(7, 'S4', 'XH4', 1, 1, 1, 400, 1, '2015-07-29 14:10:34'),
	(8, 'S5', 'XH5', 1, 1, 1, 500, 1, '2015-07-29 14:14:13'),
	(9, 'S6', 'XH6', 1, 1, 1, 600, 1, '2015-07-29 14:16:17'),
	(12, 'S7', 'XH7', 1, 1, 1, 700, 1, '2015-07-29 14:17:38');
...
CREATE TABLE IF NOT EXISTS `t_product_out` (
  ...
  `create_user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='出库单';

-- 正在导出表  kcgl.t_product_out 的数据：~2 rows (大约)
DELETE FROM `t_product_out`;
/*!40000 ALTER TABLE `t_product_out` DISABLE KEYS */;
INSERT INTO `t_product_out` (`id`, `bill_id`, `product_id`, `amount`, `stock_price`, `price`, `money`, `create_time`, `create_user_id`) VALUES
	(29, 32, 4, 1, 0, 200, 0, '2015-07-30 13:19:28', 1),
	(30, 33, 4, 1, 0, 200, 0, '2015-07-30 13:20:39', 1);
...
-- 正在导出表  kcgl.t_product_query_times 的数据：~6 rows (大约)
...
INSERT INTO `t_product_query_times` (`id`, `product_id`, `create_user_id`, `create_time`) VALUES
	...
	(2, 4, 1, '2015-07-30 23:15:14'),
	(3, 5, 1, '2015-07-30 23:15:20'),
	(4, 4, 1, '2015-07-30 23:15:24'),
	(5, 12, 1, '2015-07-30 23:36:10'),
	(6, 4, 1, '2015-07-30 23:37:17');
...
-- 正在导出表  kcgl.t_tech 的数据：~0 rows (大约)
DELETE FROM `t_tech`;
...
-- 正在导出表  kcgl.t_thickness 的数据：~0 rows (大约)
...
-- 正在导出表  kcgl.t_user_right 的数据：~0 rows (大约)

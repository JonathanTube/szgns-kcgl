				...
				.extend(
						$.fn,
						{
								...
								$(this)
										.each(
												function() {
													...
													$('#' + o.menu)
															.addClass(
																	'cleverContextMenu ui-menu ui-widget ui-widget-content ui-corner-all');
													$('#' + o.menu).css(
															cleverContextMenu);
													$('#' + o.menu)
															.find('>li')
							...
							enableContextMenuItems : function(o) {
								if (o == undefined) {
									// Enable all
									$(this).find('>li.ui-state-disabled')

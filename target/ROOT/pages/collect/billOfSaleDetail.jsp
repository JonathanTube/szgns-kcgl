		...
		$("#delete_btn").click(function(){
			jQuery.ajax({
				...
				success : function(data) {
					window.location.href='billOfSales.jsp';
				}
			});
		});
...
<body>
	...
	<div role="main" class="ui-content jqm-content">
		<table id="table_content" data-role="table" data-mode="table" class="ui-responsive table-stroke">
			<thead>
				<tr>
					<th colspan="4">深圳格纳斯/东莞晟煜 发货单</th>
		...
		<fieldset data-role="controlgroup" data-type="horizontal" style="text-align: center;">
				<a href="#" class="ui-btn ui-btn-inline">打印</a>
		...
		    <p>该步骤不能回退.</p>
		        <a href="#" class="ui-btn ui-corner-all ui-shadow ui-btn-inline ui-btn-b" data-rel="back" data-transition="flow" id="delete_btn">删除</a>

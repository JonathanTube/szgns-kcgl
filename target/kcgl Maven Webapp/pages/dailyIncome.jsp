...
<script type="text/javascript">
	$(document).ready(function() {
		$.getJSON('/queryIncomeDaily', function(data) {
			var temp = "";
			var size = data.size;
			for (var i = 0; i < size; i++) {
				temp += "<th data-priority='6'>" + (i + 1) + "</th>";
			}
			$('#table_dailyIncome thead tr th:last').before(temp);
			...
			$('#table_dailyIncome tbody').append(temp);
		});
	});
</script>
...
<div role="main" class="ui-content jqm-content">
	...
	<table id="table_dailyIncome" data-role="table"
